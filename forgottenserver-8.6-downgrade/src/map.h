...
{
	public:
		static constexpr int32_t maxViewportX = 20; //min value: maxClientViewportX + 1
		static constexpr int32_t maxViewportY = 20; //min value: maxClientViewportY + 1
		static constexpr int32_t maxClientViewportX = 19;
		static constexpr int32_t maxClientViewportY = 19;
